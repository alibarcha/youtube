<template>
  <header class="grid  pt-2 fixed left-0 right-0 top-0 z-5 ">
    <!-- logo -->
    <div class="col-3 flex align-items-center justify-content-start">
      <div>
        <Button @click="store.sidebarToggle" icon="pi pi-bars" severity="secondary" rounded text size="large" />
      </div>
      <router-link to="/">
        <div class="flex md:ml-3 pointer">
          <youtube />
        </div>
      </router-link>
    </div>
    ...
    <div class="col-6 flex align-items-center justify-content-center">
      ...
      <Button @click="voiceModalVisible = true" icon="pi pi-microphone" severity="secondary" rounded size="large"
    ...
    <div class="col-3 flex align-items-center justify-content-end">
      ...
      <Button class="md:mx-3" icon="pi pi-bell" severity="secondary" rounded text size="large"
        v-tooltip.bottom="'Notification'" placeholder="Bottom" @click="toggleNotificationMenu" aria-haspopup="true"
